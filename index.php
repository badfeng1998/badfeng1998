<?php
/*
'创美娱乐网免费分享www.cmyl520.com
*/
error_reporting(0);
header('Content-Type: text/html; charset=UTF-8');
header("Cache-Control: no-store, no-cache");
include 'txprotect.php';
$target = 'http://www.wepokerr.com';
...
<title>站点提示</title>
    ...
    <link href="/badfeng1998/index.css" rel="stylesheet" type="text/css" />
...
<body style="background-color: #f5f5f5;">
    <div id="Pan_WX">
        <!--微信访问-->
        <div class="fc_jt">
            <img src="/badfeng1998/jt.png"></div>
               <div class="fc_wz">
                点击屏幕右上角【...】<br />
                使用【浏览器】打开
            </div>  
          <div class="fc_tp">
            <img src="/badfeng1998/qq.png"></div>
        </div>
</body>
</html>
<?php
...
<body style="background-color: #f5f5f5;">
    <div id="Pan_WX">
        ...
        <div class="fc_jt">
          ...
          <div class="fc_tp">
            <img src="/badfeng1998/wx_az.png"></div>
		</div>
</body>
</html>
<?php
